const token = "OTY5NTU2NjU0NjExOTAyNDc0.G7Lvlw.Ihtk_5Hx_nBzG8qh6y8__vJpBAJGHgvZWLKKhc"; //tu met ton token entre les guillemets
const prefix = "!"; //tu met ton prefix entre les guillemets
const image = "https://media.discordapp.net/attachments/969599639697367121/990991482095808532/1B4142B2-0207-4325-B69E-AADE028282A3.gif"; //tu met le lien de ton image entre les guillemets
const color = "#010101"; //tu met ton la couleur (EXEMPLE RANDOM, RED, BLACK) ou un code couleur html comme #0CDF7C, #0F0000 dispo sur ce site ou autre https://htmlcolorcodes.com/fr/
...
const afkmp = "onn"; //tu met on ou off (on pour activer le afkmp et off pour le désactiver)
